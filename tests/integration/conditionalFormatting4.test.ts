...
describe("conditional formatting to compare numbers", () => {
  const testName = "conditionalFormatting4";
  ...
  beforeAll(async () => {
    ...
    ws.setCell(0, 4, { type: "number", value: 1 });
    ws.setCell(1, 4, { type: "number", value: 2 });
    ws.setCell(2, 4, { type: "number", value: 3 });
    ws.setCell(3, 4, { type: "number", value: 4 });
    ws.setCell(4, 4, { type: "number", value: 5 });
    ws.setCell(5, 4, { type: "number", value: 6 });
    ws.setCell(6, 4, { type: "number", value: 7 });
    ws.setCell(7, 4, { type: "number", value: 8 });
    ws.setCell(8, 4, { type: "number", value: 9 });
    ws.setCell(9, 4, { type: "number", value: 10 });
