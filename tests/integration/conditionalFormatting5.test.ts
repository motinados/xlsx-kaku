...
describe("conditional formatting for strings", () => {
  const testName = "conditionalFormatting5";
  ...
  beforeAll(async () => {
    ...
    ws.setCell(0, 0, { type: "string", value: "Lion" });
    ws.setCell(1, 0, { type: "string", value: "Elephant" });
    ws.setCell(2, 0, { type: "string", value: "Panda" });
    ws.setCell(3, 0, { type: "string", value: "Giraffe" });
    ws.setCell(4, 0, { type: "string", value: "Turtle" });
    ws.setCell(5, 0, { type: "string", value: "Apple" });
    ws.setCell(6, 0, { type: "string", value: "Banana" });
    ws.setCell(7, 0, { type: "string", value: "Strawberry" });
    ...
    ws.setCell(2, 2, { type: "string", value: "Panda" });
    ws.setCell(3, 2, { type: "string", value: "Giraffe" });
    ws.setCell(4, 2, { type: "string", value: "Turtle" });
    ws.setCell(5, 2, { type: "string", value: "Apple" });
    ws.setCell(6, 2, { type: "string", value: "Banana" });
    ws.setCell(7, 2, { type: "string", value: "Strawberry" });
    ...
    ws.setCell(3, 3, { type: "string", value: "Giraffe" });
    ws.setCell(4, 3, { type: "string", value: "Turtle" });
    ws.setCell(5, 3, { type: "string", value: "Apple" });
    ws.setCell(6, 3, { type: "string", value: "Banana" });
    ws.setCell(7, 3, { type: "string", value: "Strawberry" });
